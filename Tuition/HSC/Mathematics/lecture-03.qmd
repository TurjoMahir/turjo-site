...
::: q-card
[**Technique 1**]{.q-number}

Periods for **$\sin, \cos, \sec, \csc$** functions -

1. **When power of function are even**, Period = $\frac{2\pi}{\lvert \text{coefficient of variable} \rvert}$
2. **When power of function are odd**, Period = $\frac{\pi}{\lvert \text{coefficient of variable} \rvert}$
